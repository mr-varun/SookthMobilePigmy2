...
<head>
    ...
    <title>Change PIN - Agent Portal</title>
    ...
    <div class="container-wrapper">
        <div class="card-container">
            ...
            <div class="card-header-custom">
                ...
                <h1 class="card-title-custom">Change PIN</h1>
                <p class="card-subtitle-custom">Set your new secure PIN</p>
            </div>
            ...
            <div class="alert-warning-custom">
                ...
                <div class="alert-content">
                    <div class="alert-title">PIN Change Required</div>
                    <div class="alert-text">For security reasons, you must change your PIN before continuing.</div>
                </div>
            </div>
            ...
            <div class="card-body-custom">
                ...
                <form method="POST" action="<?= url('agent/change-pin') ?>" id="changePinForm">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-check-circle"></i> Change PIN
                    </button>
                </form>
            </div>
        </div>
